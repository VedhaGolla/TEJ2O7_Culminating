...
def draw_game_screen():
    ...
    if show_decision and not decision_made:
        ...
        gameDisplay.blit(paragraph_font.render("Speed up", True, text_color1), (365, decision_button_1.y + 18))
        ...
        gameDisplay.blit(paragraph_font.render("Stay within limit", True, text_color2), (335, decision_button_2.y + 18))
