#***********************************************
# Author: Vedha Golla & Aarnaa Sekhar
# Date: January 7, 2026
# Name: RoadMaster - Pygame culminating project
# Description: A Pygame driving simulator that includes lessons, testing, results, and a 
# realistic driving test experience focused on accuracy, awareness, and real road rules.
#***********************************************
import pygame
...
def draw_title_screen():
    ...
    # Student information
    gameDisplay.blit(paragraph_font.render("Name: Vedha Golla & Aarnaa Sekhar", True, WHITE), (30, 495))
    gameDisplay.blit(paragraph_font.render("Class Code: TEJ207", True, WHITE), (30, 515))
    gameDisplay.blit(paragraph_font.render("Date: January 7, 2026" ,True, WHITE), (30, 535))
...
def draw_game_screen():
    ...
    if current_stage == 7:
        ...
        if 150 < car_x < 275 and 180 < car_y < 320:
            parked = True
        elif 275 < car_x < 400 and 180 < car_y < 320:
            parked = True
        elif 400 < car_x < 525 and 180 < car_y < 320:
            parked = True
        elif 525 < car_x < 650 and 180 < car_y < 320:
            parked = True
